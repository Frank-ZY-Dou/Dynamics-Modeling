...
def pile_layout(n, seed, radius=0.13, cx=0.55, cy=0.0):
    ...
    for o in objs:
        ...
        out.append({"name": o["name"], "usd_path": str(ROBOLAB / o["usd_path"]), "x": cx + r * math.cos(th), "y": cy + r * math.sin(th), "z": 0.3, "yaw": yaw, "dims": [float(v) for v in rest_dims(o["dims"], rest_rotation(o["name"]))]})
